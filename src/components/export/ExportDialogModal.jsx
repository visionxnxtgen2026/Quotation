...
export default function ExportDialogModal({
  ...
  const formatOptions = [
    ...
    },
    {
      ...
      desc: "Itemized financial spreadsheet for Microsoft Excel and Tally Prime",
    ...
    },
    {
      ...
      ext: ".png",
      badge: "Graphic Snapshot",
      badgeBg: "bg-purple-50 text-purple-700 border-purple-200",
      desc: "PNG image snapshot for WhatsApp, Telegram, Email & messaging",
